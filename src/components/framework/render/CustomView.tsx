import RadarComponent from "@/components/custom/Radar";
    ...
    <div>
      ...
      <pre>
        {/* <code>{JSON.stringify(data, null, 2)}</code>
          <br /> */}
        <code>{JSON.stringify(wild, null, 2)}</code>
        <br />
        <code>{JSON.stringify(craft, null, 2)}</code>
        <br />
        <code>{JSON.stringify(mean, null, 2)}</code>
        <br />
        <code>{JSON.stringify(special, null, 2)}</code>
        <br />
      </pre>
    </div>
  );
